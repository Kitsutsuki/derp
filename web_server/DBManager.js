...
function DBManager(db, host, port, dbname) {
  ...
  var db = null;
  var connected = false;
  this.init(this.db, this.host, this.port, this.dbname);
};

DBManager.prototype.init = function(db, host, port, dbname) {
  self = this;
...
*/
DBManager.prototype.saveUser = function(job) {
  if(this.connected)
  {
...
** @param user User object
*/
DBManager.prototype.deleteUser = function(user) {
  if(this.connected)
  {
    var collection = this.db.collection('usermodels');
    collection.findOne({'_id':user._id}, function(err, doc){
...
** @return Array
*/
DBManager.prototype.getAllUsers = function(req, res) {
  if(this.connected)
  {
